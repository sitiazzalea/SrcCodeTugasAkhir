...
public class Main {
    public static void main(String[] args) {
        BigInteger[] chunks;
        // String textSecret = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum. Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.";
        // String textSecret = "!instit-ut teknologi sepuluh nopember?";
        // String textSecret = "ab";
        // byte[] binarySecret = {(byte) 0xf0, (byte) 0xf1, (byte) 0xf2, (byte) 0xf3, (byte) 0xf5}; //t3
        // byte[] binarySecret = {
        //     (byte) 0xff, (byte) 0x00, (byte) 0x19, (byte) 0x01, (byte) 0x32
        // };
        byte[] binarySecret = {
        ...
        // byte[] secretInByte = textSecret.getBytes();
        byte[] secretInByte = binarySecret;
        System.out.println("secret in bytes:");
        HelperTools.printUnsignedByteArray(secretInByte);
        System.out.println();
        ...
        chunks = PRESSHandler.split(secretInByte, chunkNumber);
        System.out.println("Split with function:");
        // // print chunks...
        for (int i = 0; i < chunks.length; i++) {
            System.out.println(chunks[i].toString());
        }
        System.out.println();
        for (int i = 0; i < chunks.length; i++) {
            HelperTools.printUnsignedByteArray(chunks[i].toByteArray());            
        }
        ...
        List<List<TLV>> parts = PRESSHandler.dealSecret(chunks, prime, secretInByte.length, chunkNumber, t, n);
        List<List<TLV>> parts2 = new ArrayList<List<TLV>>();
        parts2.add(parts.get(1));
        parts2.add(parts.get(4));
        parts2.add(parts.get(0));
        parts2.add(parts.get(2));
        ...
        String recoveredSecret = new String(recoveredSecretInBytes);
        System.out.println("Recovered secret: " + recoveredSecret);

        if (Arrays.equals(secretInByte, recoveredSecretInBytes)) {               
