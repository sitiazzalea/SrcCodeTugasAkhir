...
public class Main {
    public static void main(String[] args) {
        ...
        // String textSecret = "institut teknologi sepuluh nopember";
        // byte[] binarySecret = {
        ...
        for (byte b : secretInByte) {
            System.out.print(String.format("%02x ", b));
        }
        System.out.println();

        final int chunkNumber = 4;
        ...
        byte[] primeInByte = prime.toByteArray();
        System.out.println("Prime number in bytes");
        for (byte b : primeInByte) {
        ...
        // System.out.println("Testing reconstructData: ");
        System.out.println("Recovered secret:\n" + recoveredSecret);

        // if (textSecret.equals(recoveredSecret)) {
